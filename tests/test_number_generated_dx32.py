...
from nextrngbook.dx_generator import create_dx32, get_dx32_max_id
import numpy as np
import pandas as pd
...
# prepare _DXGenerator32 objects
...
default_dx32 = create_dx32()

largest_kk_1 = create_dx32(dx_k_1.iloc[dx_k_1["kk"].argmax()]["dx32_id"])
largest_kk_2 = create_dx32(dx_k_2.iloc[dx_k_2["kk"].argmax()]["dx32_id"])

largest_bb_1 = create_dx32(dx_k_1.iloc[dx_k_1["bb"].argmax()]["dx32_id"])
largest_bb_2 = create_dx32(dx_k_2.iloc[dx_k_2["bb"].argmax()]["dx32_id"])

largest_pp_1 = create_dx32(dx_k_1.iloc[dx_k_1["pp"].argmax()]["dx32_id"])
largest_pp_2 = create_dx32(dx_k_2.iloc[dx_k_2["pp"].argmax()]["dx32_id"])

## Random testing (#3)
current_max_dx32_id = get_dx32_max_id()
rand_t_1, rand_t_2, rand_t_3 = [create_dx32(randint(0, current_max_dx32_id + 1)) for _ in range(3)]
